      ...
      <section className="bg-primary/10 py-16 text-center">
        <div className="container mx-auto">
            ...
            <p className="mt-6 text-lg text-muted-foreground md:text-xl max-w-3xl mx-auto">
                Discover the total amount of greenhouse gases—including carbon dioxide and methane—that are generated by your actions. Understanding your carbon footprint is the first step towards a more sustainable lifestyle.
            </p>
        </div>
      </section>
